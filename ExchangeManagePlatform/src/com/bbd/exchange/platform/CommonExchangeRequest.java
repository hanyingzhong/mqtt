...
public class CommonExchangeRequest implements ExchangeRequest {
...
/*			InternalExchangeRequestMessage requestmMessasge = MobileExchangeRequestHandler.encode2Obj(message);
